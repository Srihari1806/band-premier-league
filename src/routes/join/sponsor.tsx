...
function SponsorOnboardingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await db.submitApplication("sponsor", {
              ...
              <div className="bpl-card p-6 space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Company / Brand Name *</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Industry / Category</label>
                    <input 
                      type="text" 
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Sponsorship Budget Range</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Preferred Campaign Cities (comma-separated)</label>
                    <input 
                      type="text" 
                ...
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Sponsorship & Campaign Goals</label>
                  <textarea 
                    rows={3}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Target Audience Demographics</label>
                  <input 
                    type="text" 
