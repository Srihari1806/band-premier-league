...
export const Route = createFileRoute("/join/production-house")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Apply to become a partner production house in Kalakshetra.",
      },
    ],
  }),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await db.submitApplication("production_house", {
        ...
        genres_of_interest: genres
          .split(",")
          .map((g) => g.trim())
          .filter(Boolean),
        investment_capacity: investment || undefined,
        past_artists: pastArtists
          .split(",")
          .map((a) => a.trim())
          .filter(Boolean),
          ...
          <div className="bpl-card p-12 text-center space-y-8 animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-md mx-auto text-sm leading-relaxed">
                Your partnership proposal has been submitted. Our franchise board will review the
                profile.
              </p>
            </div>
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bpl-card p-6 space-y-4">
                <h2 className="font-display font-semibold text-lg border-b border-border pb-2 text-primary-glow font-bold">
                  Company Profile
                </h2>
                ...
                <div className="space-y-1.5">
                  ...
                  {errors.companyProfile && (
                    <p className="text-red-500 text-xs">{errors.companyProfile}</p>
                  )}
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">
                      Genres of Interest (comma-separated)
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">
                      Investment Capacity Range (Annual)
                    </label>
                    <input
                      type="text"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">
                    Past Artists Worked With (comma-separated)
                  </label>
                  <input
                    type="text"
