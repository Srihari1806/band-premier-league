  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Raaga of Kurukshetra — League & Model" },
      {
        ...
        content: "How the Raaga of Kurukshetra tournament runs across India.",
      },
    ],
  }),
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Kalakshetra acts as an asset-light coordinator. We enforce a transparent **40/30/30
              event payout structure** and a **50/50 digital content royalty split** to align
              investor and artist incentives.
            </p>
          </div>
            ...
            <div className="bpl-card p-8 flex flex-col justify-between text-left space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-primary-glow mt-1">
                    To Artists (Live Events)
                  </p>
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Bands receive a direct 40% split of ticket pass sales per show. They also retain a
                  50% share of all digital music stream and video monetization royalties.
                </p>
              </div>
              <div className="border-t border-border pt-4">
                <span className="text-[10px] uppercase font-bold text-muted-foreground">
                  Ecosystem Value: Artist Livelihood
                </span>
              </div>
            </div>
            ...
            <div className="bpl-card p-8 flex flex-col justify-between text-left space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-primary-glow mt-1">
                    To Production House (Investor)
                  </p>
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  The band's investing Production House receives a 30% ticketing split per show.
                  This aligns their incentives directly with the live performance success of their
                  drafted roster.
                </p>
              </div>
              <div className="border-t border-border pt-4">
                <span className="text-[10px] uppercase font-bold text-muted-foreground">
                  Ecosystem Value: Franchise ROI
                </span>
              </div>
            </div>
            ...
            <div className="bpl-card p-8 flex flex-col justify-between text-left space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-4xl font-display font-bold text-white">30% Share</h3>
                  <p className="text-sm font-bold text-primary-glow mt-1">
                    To Kalakshetra Operator
                  </p>
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Kalakshetra retains 30% of ticket pass sales. This commission covers tournament
                  operations, prize pools, software license fees, and outsourcing on-ground event
                  coordinators.
                </p>
              </div>
              <div className="border-t border-border pt-4">
                <span className="text-[10px] uppercase font-bold text-muted-foreground">
                  Ecosystem Value: Tournament Operations
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left space-y-6">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-white">
                The Phase 1 Validation Pilot
              </h2>
            </div>

            <p className="text-xs text-muted-foreground leading-relaxed">
              We believe in validating economic assumptions on the ground before national scaling.
              Kalakshetra is launching an initial **8-week proof-of-concept pilot in Hyderabad** to
              optimize ticketing splits, validate the ₹199 entry price hook, and capture real fan
              attendance data.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-0.5">
                    Operating within 6 curated partner cafes to run localized weekend tournaments.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-0.5">
                    Rotating 4 selected pilot bands to validate repeat attendance and fan base
                    crossover.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-0.5">
                    A structured schedule designed to build steady weekend gig habits among local
                    college communities.
                  </p>
                </div>
              </div>
          ...
          <div className="bpl-card p-8 text-left space-y-6 bg-gradient-to-br from-secondary/50 to-transparent">
            <div>
              <h3 className="text-lg font-display font-bold text-white">
                Hyderabad Pilot Economics
              </h3>
              <p className="text-xs text-muted-foreground mt-0.5">
                Modeled target projections per month.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 border border-border rounded-lg bg-surface/30">
                ...
                <p className="text-xl font-display font-bold text-primary-glow mt-1">
                  ₹11.77 Lakhs
                </p>
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 space-y-2">
              ...
              <p className="text-[10px] text-muted-foreground leading-normal">
                This Hyderabad proof-of-concept serves as our seed pitch metrics. It replaces
                nationwide assumptions with validated, local operational benchmarks.
              </p>
            </div>
          </div>
        </div>
